            ...
            if (!appCurrentUser) {
                return (
                    <>
                        ...
                        <Button
                            className={classes.navButton}
                            href="/hackathon/organize/overview"
                        >
                            Organize a Hackathon
                        </Button>
                        <Button
                            variant="contained"
                            className={classes.navButtonContained}
                            href="/auth/signin"
                        >
                            Sign In
                        </Button>
            ...
            if (appCurrentUser.userType === "developer") {
                return (
                    <>
                        <Button
                            className={classes.navButton}
                            onClick={() => navClickHandler("codeeditor")}
                        >
                            Code Editor
                        </Button>
                        <Button
                            className={classes.navButton}
                            onClick={() => navClickHandler("learn")}
                        >
                            Learn
                        </Button>
                        <Button
                            className={classes.navButton}
                            onClick={() => navClickHandler("practice")}
                        >
                            Practice
                        </Button>
                        <Button className={classes.navButton}
                    ...
                    return (
                        <div>
                            ...
                            <MenuItem>
                                <Button
                                    className={classes.navButton}
                                    onClick={() => navClickHandler("explore")}
                                >
                                    Explore
                                </Button>
                            </MenuItem>
