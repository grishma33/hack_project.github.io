...
const SignIn = () => {
        ...
        try {
            axios
                ...
                .then((response) => {
                    ...
                    console.log('login Res====>' , response , response.data.data.userType)
                    if (response) {
    ...
    const validateForm = (name, fieldValue) => {
        ...
        if (name === "password" && !Passval.test(fieldValue)) {
            fieldErrors.push(
                <p name={name} className={classes.errorMessage} key={name}>
                    MinLength should be 8 characters,atleast one uppercase , one lowercase and one number and one special Character
                </p>
            );
        }
                            ...
                            <Grid item xs={12} md={12} sm={12}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Link href="http://localhost:3000/auth/forgot">
                                            <b
                                                style={{
