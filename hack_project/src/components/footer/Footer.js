            ...
            >
                ...
                >
                    <center>
                        ...
                        <IconButton style={{ marginTop: "20px", marginBottom: "20px" } }
                        >
                            {/* <img src={getIcon('facebook')} style={{height: "40px"}} alt="Facebook" />  */}
                            <img src={getIcon('facebook')} style={{height: "40px"}} alt="Facebook" onClick={() => window.open('https://www.Linkedin.com')}/>
                        ...
                        >
                            ...
                            <img src={getIcon('instagram')} style={{height: "40px"}} alt="Instagram" onClick={() => window.open('https://www.instagram.com/')}/>
                        </IconButton>
                        ...
                        >
                            ...
                            <img src={getIcon('mail')} style={{height: "40px"}} alt="EMail" onClick={() => window.open('https://mail.google.com/mail/u/0/#inbox')} />
                        ...
                        >
                            ...
                            <img src={getIcon('twitter')} style={{height: "40px"}} alt="Twitter" onClick={() => window.open('https://github.com/grishma33')} />
                        </IconButton>
                    </center>
                </Grid>
